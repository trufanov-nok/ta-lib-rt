...
*TA_DATA_RETREIVE_TIMEOUT = *Finance::TAc::TA_DATA_RETREIVE_TIMEOUT;
...
*TA_SOURCE_USES_END_OF_PERIOD = *Finance::TAc::TA_SOURCE_USES_END_OF_PERIOD;
...
*TA_USE_END_OF_PERIOD = *Finance::TAc::TA_USE_END_OF_PERIOD;
